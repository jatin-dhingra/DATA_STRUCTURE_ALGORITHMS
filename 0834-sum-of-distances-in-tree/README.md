...
<pre style="position: relative;"><strong>Input:</strong> n = 6, edges = [[0,1],[0,2],[2,3],[2,4],[2,5]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 1, edges = []
<strong>Output:</strong> [0]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>
<img alt="" src="https://assets.leetcode.com/uploads/2021/07/23/lc-sumdist3.jpg" style="width: 144px; height: 145px;">
<pre style="position: relative;"><strong>Input:</strong> n = 2, edges = [[1,0]]
