...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,13,10,12,31]
...
The number of distinct integers in this array is 6 (The numbers 1, 10, 12, 13, 21, and 31).<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
