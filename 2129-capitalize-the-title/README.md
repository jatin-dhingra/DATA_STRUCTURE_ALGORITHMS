...
<pre style="position: relative;"><strong>Input:</strong> title = "capiTalIze tHe titLe"
...
<pre style="position: relative;"><strong>Input:</strong> title = "First leTTeR of EACH Word"
...
<pre style="position: relative;"><strong>Input:</strong> title = "i lOve leetcode"
