...
<pre style="position: relative;"><strong>Input:</strong> words = ["aba","bcb","ece","aa","e"], queries = [[0,2],[1,4],[1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> words = ["a","e","i"], queries = [[0,2],[0,1],[2,2]]
<strong>Output:</strong> [3,2,1]
<strong>Explanation:</strong> Every string satisfies the conditions, so we return [3,2,1].<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
